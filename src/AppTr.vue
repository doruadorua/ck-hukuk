        ...
        <div class="container">
          <div class="row" style="overflow: auto;">
            ...
            <div style="padding-top:3vh; float:right;">
              <img @click="goEnglish" src="src/images/english_flag.png" style="width:30px;cursor:pointer;">
            </div>
          </div>
        </div>
      </nav>
            ...
            <div class="col-md-8 col-md-offset-2 text-center">
              <div class="display-t">
                <div class="display-tc animate-box" data-animate-effect="fadeIn">
                  <h1 class="baslik">Yapım Aşamasındayız!</h1>
                        ...
                        <transition :name="anim" mode="out-in">
                          <div class="form-group" v-if="!getSaved">
                            <vue-tel-input class="form-control" id="email"
                                            ...
                                            @onInput="onInput"
                                            required
                                            placeholder="Telefonunuzu bırakın, sizi arayalım."
                                            defaultCountry="TR">
                            </vue-tel-input>
                            <button class="btn btn-primary" @click.prevent="saveUser">Gönder</button>
                            <br>
                            <small v-if="notValid" style="color:red;float:left">Seçilen ülke ve girilen telefon numarası uyuşmuyor. Lütfen tekrar deneyiniz.</small>
                          </div>
                          <p v-else style="marginBottom:8px"> En yakın zamanda sizinle iletişime geçeceğiz.<br> İlginiz için teşekkürler.  </p>
                        </transition>
                      </div>
                    </form>
...
export default {
  ...
  created(){
    ...
    this.$loadScript('../src/js/simplyCountdown.js')
    .then(() => {
